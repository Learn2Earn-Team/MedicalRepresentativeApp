"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["src_app_pages_product-presentation_product-presentation_module_ts"],{

/***/ 9889:
/*!***********************************************************************************!*\
  !*** ./src/app/pages/product-presentation/product-presentation-routing.module.ts ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ProductPresentationPageRoutingModule": () => (/* binding */ ProductPresentationPageRoutingModule)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 2816);
/* harmony import */ var _product_presentation_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./product-presentation.page */ 7234);
...
const routes = [
    {
        path: '',
        component: _product_presentation_page__WEBPACK_IMPORTED_MODULE_0__.ProductPresentationPage
    }
];
let ProductPresentationPageRoutingModule = class ProductPresentationPageRoutingModule {
};
ProductPresentationPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], ProductPresentationPageRoutingModule);
...
/***/ 3503:
/*!***************************************************************************!*\
  !*** ./src/app/pages/product-presentation/product-presentation.module.ts ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ProductPresentationPageModule": () => (/* binding */ ProductPresentationPageModule)
/* harmony export */ });
...
/* harmony import */ var _product_presentation_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./product-presentation-routing.module */ 9889);
/* harmony import */ var _product_presentation_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./product-presentation.page */ 7234);
...
let ProductPresentationPageModule = class ProductPresentationPageModule {
};
ProductPresentationPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule,
            _product_presentation_routing_module__WEBPACK_IMPORTED_MODULE_0__.ProductPresentationPageRoutingModule,
            swiper_angular__WEBPACK_IMPORTED_MODULE_7__.SwiperModule
        ],
        declarations: [_product_presentation_page__WEBPACK_IMPORTED_MODULE_1__.ProductPresentationPage]
    })
], ProductPresentationPageModule);
...
/***/ 7234:
/*!*************************************************************************!*\
  !*** ./src/app/pages/product-presentation/product-presentation.page.ts ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ProductPresentationPage": () => (/* binding */ ProductPresentationPage)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _product_presentation_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./product-presentation.page.html?ngResource */ 4340);
/* harmony import */ var _product_presentation_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./product-presentation.page.scss?ngResource */ 2982);
...
let ProductPresentationPage = class ProductPresentationPage {
    constructor(route, apicall, global) {
        ...
        this.data = [{ path: "./../../../assets/prodcuts/product.jpeg" }, { path: "./../../../assets/creat3.png" }, { path: "./../../../assets/dcr-m.jpg" }, { path: "./../../../assets/prodcuts/product.jpeg" }];
        // this.selectedSegment.p_name = this.segmentList[0];
    ...
    ionViewDidEnter() {
        ...
        this.selectedSegment.p_name = company.p_name;
        this.segment.nativeElement.scrollIntoView({
            behavior: 'smooth'
        });
    }
    ngOnInit() {
        // this.getAllProducts();
        this.products = history.state.companies;
        const company = history.state.company;
        const index = history.state.index;
        //this.slide.slideTo(index);
        // this.ionSlideDidChange(this.slide, index, 'state');
    ...
    all_products() {
        this.route.navigate(['product-company']);
    }
    ionSlideDidChange($event, index, type) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            console.log($event.target);
            const x = this.slide.getActiveIndex().then(index => {
                console.log(index + 1);
                for (let i = 0; i < this.products; i++) {
                    if (this.products[i].p_id === index) {
                        this.selectedSegment.p_name = this.products[i].p_name;
                        console.log(this.selectedSegment);
                        this.onSegmentChange($event.target.value = this.selectedSegment.p_name);
                    }
                }
            });
            console.log(x);
...
ProductPresentationPage.ctorParameters = () => [
...
ProductPresentationPage.propDecorators = {
    segment: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_7__.ViewChild, args: ['segment',] }],
    slide: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_7__.ViewChild, args: ['slide', { static: false },] }]
};
ProductPresentationPage = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        selector: 'app-product-presentation',
        template: _product_presentation_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_product_presentation_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
...
/***/ 2982:
/*!**************************************************************************************!*\
  !*** ./src/app/pages/product-presentation/product-presentation.page.scss?ngResource ***!
  \**************************************************************************************/
/***/ ((module) => {

module.exports = "img {\n  width: 100%;\n  height: 100%;\n  object-fit: fill;\n}\n\n.toolbar1 {\n  --background: transparent;\n  --ion-color-base: transparent !important;\n}\n\n.toolbar1 .backicon {\n  font-size: 20px;\n  margin-left: 10px;\n  margin-top: 5px;\n}\n\n.toolbar1 .addD {\n  color: #1E6FD9;\n  text-align: center;\n  font-size: x-large;\n  font-weight: 800;\n}\n\n.toolbar1 .refresh_button_set {\n  width: 30px;\n  height: 30px;\n  float: right;\n  background: #0D65D9;\n  border-radius: 9px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  cursor: pointer;\n}\n\n.toolbar1 .refrsh_img {\n  width: 20px;\n  height: 20px;\n  display: flex;\n  margin: auto;\n}\n\n.product_footer {\n  display: flex;\n  background: #1E6FD9;\n  height: 35px;\n  flex-wrap: wrap;\n  justify-content: space-around;\n  align-content: center;\n}\n\n.product_footer p {\n  color: white;\n  text-align: center;\n  font-size: 18px;\n}\n\n.refresh_button_set {\n  width: 30px;\n  height: 30px;\n  float: right;\n  background: #0D65D9;\n  border-radius: 9px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  cursor: pointer;\n  margin-top: 5px;\n  margin-right: 10px;\n}\n\nh6 {\n  float: right;\n  font-weight: bolder;\n  color: #0D65D9;\n  margin: auto 10px;\n}\n\nion-slides {\n  height: 94%;\n}\n\nion-card {\n  height: 100%;\n  width: 100%;\n  margin: 0;\n  --background: #e3f2fd;\n}\n\nimg {\n  border-radius: 10px;\n  height: 100%;\n}\n\nion-segment {\n  width: 100%;\n  margin-left: auto;\n  margin-right: auto;\n  border: 1px solid #eee;\n  --background: #fff;\n  border-radius: 0;\n}\n\nion-segment-button {\n  border-radius: 0;\n  --background: #fff;\n  --background-checked: var(--ion-color-primary);\n  --indicator-color: var(--ion-color-primary);\n  --border: none;\n  --color-checked: #fff;\n  height: 100%;\n  padding: 5px;\n}\n\nion-segment-button::part(indicator-background) {\n  background: #3b6dc3;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

/***/ }),

/***/ 4340:
/*!**************************************************************************************!*\
  !*** ./src/app/pages/product-presentation/product-presentation.page.html?ngResource ***!
  \**************************************************************************************/
/***/ ((module) => {

module.exports = "\r\n\r\n<ion-content>\r\n\r\n\r\n<ion-slides pager=\"true\"  id=\"slides\" #slide (ionSlideDidChange)=\"ionSlideDidChange($event)\">\r\n  <ion-slide *ngFor=\"let d of products\">\r\n    <ion-card>\r\n      <img src=\"{{d.p_img}}\">\r\n    </ion-card>\r\n  </ion-slide>\r\n</ion-slides>\r\n\r\n\r\n<!-- <swiper [pagination]=\"true\">\r\n  <ng-template swiperSlide *ngFor=\"let data of product_img\" >\r\n    <img src={{data.img}}>\r\n  </ng-template>\r\n  </swiper>\r\n\r\n</ion-content>\r\n\r\n\r\n<ion-list class=\"product_footer\">\r\n<div *ngFor=\"let company of product\">\r\n  <p>{{this.company.name}}</p>\r\n</div> -->\r\n<!-- </ion-list> -->\r\n\r\n</ion-content>\r\n<ion-segment #segment  [scrollable]=\"true\"  [(ngModel)]=\"selectedSegment.p_name\"  (ionChange)=\"onSegmentChange($event)\">\r\n<ion-segment-button  id={{selectedSegment.p_name}}  [value]=\"item.p_name\" *ngFor=\"let item of products;let i = index\"\r\n  (click)=\"_segmentSelected(item.p_name,i)\">\r\n  <ion-label>{{item.p_name}}</ion-label>\r\n</ion-segment-button>\r\n</ion-segment>";
...
/* harmony import */ var _shared_get_device_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/get-device.js */ 1373);
/* harmony import */ var _shared_get_browser_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../shared/get-browser.js */ 59);
...
/* harmony import */ var _modules_effect_fade_effect_fade_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./modules/effect-fade/effect-fade.js */ 8234);
...
//# sourceMappingURL=src_app_pages_product-presentation_product-presentation_module_ts.js.map